      ...
      >
        ...
        <div className="showNavMobile">
          <ToggelSidebar isRight={true}>
            <Bars3 class="w-6 h-6 text-zinc-700 dark:text-white" />
          </ToggelSidebar>
        </div>
        ...
        >
          ...
          <div className="flex items-center justify-between pb-5 mb-6 border-b border-b-gray-100 dark:border-b-white/10">
            ...
            <div className="flex gap-x-.5  ">
              ...
              <LogoType class="w-[100px] h-10 text-orange-300" />
            </div>
            ...
            <span>
              <ToggelSidebar isRight={true}>
                <XMark class="w-5 h-5 text-zinc-600 dark:text-white  " />
              </ToggelSidebar>
            </span>
          </div>
          ...
          <ul className="child:pr-2.5 text-zinc-600 dark:text-white space-y-6">
            ...
            <li className="mt-4">
              <div className="flex items-center justify-between">
                <a href="" className="inline-flex items-center gap-x-2">
                  <ShoppingBag class="w-5 h-5 text-zinc-600 dark:text-white" />
                  فروشگاه
                </a>
                <span
                ...
                >
                  <ChevronDown class="w-4 h-4 text-zinc-600 dark:text-white" />
                </span>
              </div>
              <div
            ...
            <li>
              <a href="" className="inline-flex items-center gap-x-2">
                <ChatBubbleLeftEllipsis class="w-5 h-5 text-zinc-600 dark:text-white" />
                دیکشنری
              </a>
            </li>
            ...
            <li>
              <a href="" className="inline-flex items-center gap-x-2">
                <Briefcase class="w-5 h-5 text-zinc-600 dark:text-white" />
                درباره ما
              </a>
            </li>
            ...
            <li className="">
              <a href="" className="inline-flex items-center gap-x-2">
                <DocumentText class="w-5 h-5 text-zinc-600 dark:text-white" />
                بلاگ
              </a>
            </li>
            ...
            <li>
              <a href="" className="inline-flex items-center gap-x-2">
                <PhoneArrowDownleft class="w-5 h-5 text-zinc-600 dark:text-white" />
                تماس با ما
              </a>
            </li>
          </ul>
          ...
          <div className="flex flex-col items-start gap-6 pt-8 px-2.5 mt-8 border-t text-orange-300 border-t-gray-100 dark:border-t-white/10">
            <a href="" className="inline-flex items-center gap-x-2">
              <ArrowLeftEndOnRectangle class="w-5 h-5 rotate-180" />
              ورود | ثبت نام
            </a>
            <div className="inline-block btnDarkmode cursor-pointer">
              <DarkMode size="w-5 h-5" textM="حالت تیره" textS="حالت روشن" />
            </div>
            <a href="" className="inline-flex items-center gap-x-2">
        ...
        <div className="btnShowCartMobile">
          <ToggelSidebar isRight={false}>
            <ShoppingCart class="w-6 h-6 text-zinc-700 dark:text-white" />
          </ToggelSidebar>
        </div>
        {/* <!-- cart --> */}
        {/* <!-- hidden-o -Left --> */}
